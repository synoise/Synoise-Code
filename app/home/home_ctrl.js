(function () {
    ...
    angular.module("iApp", ['smart-table', 'ngDraggable'])
        ...
        }).controller('TestController', function ($scope, $http, $filter, orderByFilter, filterFilter, myhttpserv) {
        ...
        myhttpserv.then(function (response) {
            ...
            /*   var httpPost = function () {
             $http.post('save.php', {"aa":JSON.stringify($scope.todos)})
             .error(function (status) {
             console.log(status)
             });
             }; */

            // $scope.todos = [{"aaa":"ccc"},{"aaa":"ccc"},{"aaa":"ccc"}]
        ...
        $scope.loadJSONtoScope = function (adress, pack, type) {
            $http({method: "GET", url: adress}).then(function mySucces(response) {
                ...
                $http({method: "GET", url: "./json/pakiety2.json?=" + pack+"?="+Math.random()}).then(function mySucces(response) {
